  ...
  private
    ...
    def set_loyalty_points_settings
      @preferences_loyalty_points = {
        ...
        :loyalty_points_awarding_unit => [Spree.t(:loyalty_points_awarding_unit_description)],
        :loyalty_points_redeeming_balance => [""],
        :loyalty_points_conversion_rate => [Spree.t(:loyalty_points_conversion_rate_description)],
